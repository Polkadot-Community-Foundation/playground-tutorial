...
**Escape hatch:** if the developer clearly says they just want a one-off change and want to skip the tutorial framing, respect that — but still tell them _once_ which level the change belongs to, so they know the tutorial is here when they want it.
